        ...
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <Button variant="transparent" className='font-semibold text-lg w-auto p-1.5 overflow-hidden' size="sm">
                    <span className='truncate'>{workspace.name.toUpperCase()}</span>
                    <ChevronDown className='size-4 ml-1 shrink-0'/>
                </Button>
            </DropdownMenuTrigger>
            <DropdownMenuContent side='bottom' align='start' className='w-64'>
                <DropdownMenuItem className='cursor-pointer capitalize'>
                    <div className='size-9 relative overflow-hidden bg-[#5691c8] text-white font-semibold text-xl rounded-md flex items-center justify-center mr-2'>
