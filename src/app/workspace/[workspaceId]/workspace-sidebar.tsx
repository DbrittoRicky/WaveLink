...
const WorkspaceSidebar = () => {
    ...
    if(workspaceLoading || memberLoading) {
        return (
            <div className='flex flex-col bg-[#5691c8] h-full items-center justify-center'>
    ...
    if(!workspace || !member) {
        return (
            <div className='flex flex-col gap-y-2 bg-[#5691c8] h-full items-center justify-center'>
