...
export const Message = ({
    ...
    const {mutate: removeMessage, isPending: isRemovingMessage} = useDeleteMessage();
    ...
    return (
        ...
        <ConfirmDialog />
        <div className={cn(
            "flex flex-col gap-2 p-1.5 px-5 hover:bg-sky-100/60 group relative",
            isEditing && "bg-[#44f2be33] hover:bg-[#44f2be33]",
